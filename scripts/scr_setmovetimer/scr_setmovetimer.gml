...
function scr_setmovetimer(){
	...
	}else if (room = NIGHT_10){
		movetimer = obj_game.movetimer_night10 + irandom_range(-5, 5)
	}else if (room = NIGHT_CUSTOM){
		movetimer = obj_game.movetimer_custom + irandom_range(-5, 5)
	}
