...
if (menu_option = "play"){
	...
	draw_sprite_ext(spr_menubg, 0, 2560 - scroll, 2560 - scroll, 1, 1, 0, c_white, 0.2)
	draw_sprite_ext(spr_menubg, 0, 0 - scroll, 2560 - scroll, 1, 1, 0, c_white, 0.2)
	draw_sprite_ext(spr_menubg, 0, 2560 - scroll, 0 - scroll, 1, 1, 0, c_white, 0.2)
